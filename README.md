...
- ✅ **Родовое дерево (family_tree.html)** — интерактивная визуализация семейных связей (Graphviz); связи родитель/супруг/со-родитель; цветовые ветки без наложений; co-parent adjacency; pan/zoom; дата рождения; admin кнопки создания персон/связей/удаления; выдвижная легенда
