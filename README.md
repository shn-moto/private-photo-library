...
- **Информация о фото (ℹ)** — EXIF-данные (GPS, камера, объектив, ISO, даты) в попапе по кнопке ℹ в lightbox; бэйдж ℹ на миниатюрах
...
- **Lightbox с лицами:**
  ...
  - Кнопка ℹ — EXIF-информация (камера, объектив, ISO, GPS, даты)
...
- ✅ **Сортировка результатов** — серверная сортировка по ID / дате (sort_by в API)- **Библиотека книг** — разбиение HTML-книг на главы с оглавлением; pHash-сопоставление картинок с фотоархивом; ссылки на карту по image_id; стилизованная книжная полка
## Планы развития
